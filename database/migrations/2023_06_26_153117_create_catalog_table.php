...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        /* TIPO DE UNIDAD DE MEDIDA - CATALOGO 3 */
        ...
        /* TIPO DE DOCUMENTO DE IDENTIDAD - CATALOGO 6 */
        ...
        DB::table('cat_identity_document_types')->insert([
            ['code' => '0', 'active' => true,  'description' => 'Doc.trib.no.dom.sin.ruc'],
            ['code' => '1', 'active' => true,  'description' => 'DNI'],
            ['code' => '4', 'active' => true,  'description' => 'CE'],
            ['code' => '6', 'active' => true,  'description' => 'RUC'],
            ['code' => '7', 'active' => true,  'description' => 'Pasaporte'],
            ['code' => 'A', 'active' => false, 'description' => 'Ced. Diplomática de identidad'],
            ['code' => 'B', 'active' => false, 'description' => 'Documento identidad país residencia-no.d'],
            ['code' => 'C', 'active' => false, 'description' => 'Tax Identification Number - TIN – Doc Trib PP.NN'],
            ['code' => 'D', 'active' => false, 'description' => 'Identification Number - IN – Doc Trib PP. JJ'],
            ['code' => 'E', 'active' => false, 'description' => 'TAM- Tarjeta Andina de Migración'],
        ]);

        /* TIPO DE AFECTACION IGV - CATALOGO 7 */
        ...
        DB::table('cat_affectation_igv_types')->insert([
            ['code' => '10', 'active' => true,  'exportation' => false, 'free' => false, 'description' => 'Gravado - Operación Onerosa'],
            ['code' => '11', 'active' => true,  'exportation' => false, 'free' => true,  'description' => 'Gravado – Retiro por premio'],
            ['code' => '12', 'active' => true,  'exportation' => false, 'free' => true,  'description' => 'Gravado – Retiro por donación'],
            ['code' => '13', 'active' => true,  'exportation' => false, 'free' => true,  'description' => 'Gravado – Retiro'],
            ['code' => '14', 'active' => true,  'exportation' => false, 'free' => true,  'description' => 'Gravado – Retiro por publicidad'],
            ['code' => '15', 'active' => true,  'exportation' => false, 'free' => true,  'description' => 'Gravado – Bonificaciones'],
            ['code' => '16', 'active' => true,  'exportation' => false, 'free' => true,  'description' => 'Gravado – Retiro por entrega a trabajadores'],
            ['code' => '17', 'active' => false, 'exportation' => false, 'free' => true,  'description' => 'Gravado – IVAP'],
            ['code' => '20', 'active' => true,  'exportation' => false, 'free' => false, 'description' => 'Exonerado - Operación Onerosa'],
            ['code' => '21', 'active' => true,  'exportation' => false, 'free' => true,  'description' => 'Exonerado – Transferencia Gratuita'],
            ['code' => '30', 'active' => true,  'exportation' => false, 'free' => false, 'description' => 'Inafecto - Operación Onerosa'],
            ['code' => '31', 'active' => true,  'exportation' => false, 'free' => true,  'description' => 'Inafecto – Retiro por Bonificación'],
            ['code' => '32', 'active' => true,  'exportation' => false, 'free' => true,  'description' => 'Inafecto – Retiro'],
            ['code' => '33', 'active' => true,  'exportation' => false, 'free' => true,  'description' => 'Inafecto – Retiro por Muestras Médicas'],
            ['code' => '34', 'active' => true,  'exportation' => false, 'free' => true,  'description' => 'Inafecto - Retiro por Convenio Colectivo'],
            ['code' => '35', 'active' => true,  'exportation' => false, 'free' => true,  'description' => 'Inafecto – Retiro por premio'],
            ['code' => '36', 'active' => true,  'exportation' => false, 'free' => true,  'description' => 'Inafecto - Retiro por publicidad'],
            ['code' => '37', 'active' => true,  'exportation' => false, 'free' => true,  'description' => 'Inafecto - Transferencia gratuita'],
            ['code' => '40', 'active' => false,  'exportation' => true,  'free' => false, 'description' => 'Exportación de bienes o servicios'],
        ]);

        /* TIPOS DE CALCULO DE ISC - CATALOGO 8 */
        ...
        /* TIPOS DE NOTA DE CREDITO - CATALOGO 9 */
        ...
        /* TIPOS DE NOTA DE DEBITO - CATALOGO 10 */
        ...
        /* Código de documentos relacionados tributarios - CATALOGO 12 */
        ...
        /* OTROS CONCEPTOS TRIBUTARIOS - CATALOGO 14 */
        ...
        /* CODIGO DE TIPO DE PRECIO DE VENTA UNITARIO - CATALOGO 16 */
        ...
        /* CODIGO DE MODALIDAD DE TRANSPORTE - CATALOGO 18 */
        ...
        /* CODIGO DE ESTADO DEL ITEM (RESUMEN DIARIO) - CATALOGO 19 */
        ...
        /* CODIGO DE MOTIVO DE TRASLADO - CATALOGO 20 */

        Schema::create('cat_transfer_reason_types', function (Blueprint $table) {
            $table->string('id')->index();
            $table->boolean('active');
            $table->boolean('discount_stock');
            $table->string('description');
        });

        DB::table('cat_transfer_reason_types')->insert([
            ['id' => '01', 'active' => true, 'discount_stock' => false, 'description' => 'Venta'],
            ['id' => '02', 'active' => true, 'discount_stock' => false, 'description' => 'Compra'],
            ['id' => '04', 'active' => true, 'discount_stock' => false, 'description' => 'Traslado entre establecimientos de la misma empresa'],
            ['id' => '08', 'active' => true, 'discount_stock' => false, 'description' => 'Importación'],
            ['id' => '09', 'active' => true, 'discount_stock' => false, 'description' => 'Exportación'],
            ['id' => '13', 'active' => true, 'discount_stock' => false, 'description' => 'Otros'],
            ['id' => '14', 'active' => true, 'discount_stock' => false, 'description' => 'Venta sujeta a confirmación del comprador'],
            ['id' => '18', 'active' => true, 'discount_stock' => false, 'description' => 'Traslado emisor itinerante CP'],
            ['id' => '19', 'active' => true, 'discount_stock' => false, 'description' => 'Traslado a zona primaria'],
        ]);

        /* CODIGO DE DOCUMENTOS RELACIONADOS (SOLO GUIA DE REMISION ELECTRONICA) - CATALOGO 21 */
        ...
        /* CODIGO DE REGIMEN DE PERCEPCIONES - CATALOGO 22 */
        ...
        /* CODIGO DE REGIMEN DE RETENCIONES - CATALOGO 23 */
        ...
        /* CODIGO DE TIPO DE OPERACION - CATALOGO 51 */

        Schema::create('cat_operation_types', function (Blueprint $table) {
            $table->string('id')->index();
            $table->boolean('active')->default(true);
            $table->boolean('exportation')->default(false);
            $table->string('description');
        });

        DB::table('cat_operation_types')->insert([
            ['id' => '0101', 'active' => '1', 'exportation' => '0', 'description' => 'Venta interna'],
            ['id' => '0112', 'active' => '0', 'exportation' => '0', 'description' => 'Venta Interna - Sustenta Gastos Deducibles Persona Natural'],
            ['id' => '0113', 'active' => '0', 'exportation' => '0', 'description' => 'Venta Interna - NRUS'],
            ['id' => '0200', 'active' => '0', 'exportation' => '1', 'description' => 'Exportación de Bienes'],
            ['id' => '0201', 'active' => '0', 'exportation' => '1', 'description' => 'Exportación de Servicios – Prestación servicios realizados íntegramente en el país'],
            ['id' => '0202', 'active' => '0', 'exportation' => '1', 'description' => 'Exportación de Servicios – Prestación de servicios de hospedaje No Domiciliado'],
            ['id' => '0203', 'active' => '0', 'exportation' => '1', 'description' => 'Exportación de Servicios – Transporte de navieras'],
            ['id' => '0204', 'active' => '0', 'exportation' => '1', 'description' => 'Exportación de Servicios – Servicios a naves y aeronaves de bandera extranjera'],
            ['id' => '0205', 'active' => '0', 'exportation' => '1', 'description' => 'Exportación de Servicios - Servicios que conformen un Paquete Turístico'],
            ['id' => '0206', 'active' => '0', 'exportation' => '1', 'description' => 'Exportación de Servicios – Servicios complementarios al transporte de carga'],
            ['id' => '0207', 'active' => '0', 'exportation' => '1', 'description' => 'Exportación de Servicios – Suministro de energía eléctrica a favor de sujetos domiciliados en ZED'],
            ['id' => '0208', 'active' => '0', 'exportation' => '1', 'description' => 'Exportación de Servicios – Prestación servicios realizados parcialmente en el extranjero'],
            ['id' => '0301', 'active' => '0', 'exportation' => '0', 'description' => 'Operaciones con Carta de porte aéreo (emitidas en el ámbito nacional)'],
            ['id' => '0302', 'active' => '0', 'exportation' => '0', 'description' => 'Operaciones de Transporte ferroviario de pasajeros'],
            ['id' => '0303', 'active' => '0', 'exportation' => '0', 'description' => 'Operaciones de Pago de regalía petrolera'],
            ['id' => '0401', 'active' => '1', 'exportation' => '0', 'description' => 'Ventas no domiciliados que no califican como exportación'],
            ['id' => '1001', 'active' => '1', 'exportation' => '0', 'description' => 'Operación Sujeta a Detracción'],
            ['id' => '1002', 'active' => '0', 'exportation' => '0', 'description' => 'Operación Sujeta a Detracción- Recursos Hidrobiológicos'],
            ['id' => '1003', 'active' => '0', 'exportation' => '0', 'description' => 'Operación Sujeta a Detracción- Servicios de Transporte Pasajeros'],
            ['id' => '1004', 'active' => '1', 'exportation' => '0', 'description' => 'Operación Sujeta a Detracción- Servicios de Transporte Carga'],
            ['id' => '2001', 'active' => '0', 'exportation' => '0', 'description' => 'Operación Sujeta a Percepción'],
            ['id' => '0501', 'active' => '1', 'exportation' => '0', 'description' => 'Compra interna'],
        ]);

        /* CODIGO DE TIPO DE LEYENDA - CATALOGO 52 */
        ...
        /* CODIGOS DE CARGOS Y DESCUENTOS - CATALOGO 53 */
        ...
        /* CODIGOS DE BIENES Y SERVICIOS SUJETOS A DETRACCIONES - CATALOGO 54 */

        Schema::create('codes_items_services_subject_detraction', function (Blueprint $table) {
            $table->string('id')->index();
            $table->string('code');
            $table->string('description');
        ...
        DB::table('codes_items_services_subject_detraction')->insert([
            ['id' => '54001',  'code' => '001', 'active' => true, 'percentage' => 0, 'description' => 'Azúcar y melaza de caña'],
            ['id' => '54002',  'code' => '002', 'active' => true, 'percentage' => 0, 'description' => 'Arroz'],
            ['id' => '54003',  'code' => '003', 'active' => true, 'percentage' => 0, 'description' => 'Alcohol etílico'],
            ['id' => '54004',  'code' => '004', 'active' => true, 'percentage' => 4, 'description' => 'Recursos hidrobiológicos'],
            ['id' => '54005',  'code' => '005', 'active' => true, 'percentage' => 4, 'description' => 'Maíz amarillo duro'],
            ['id' => '54007',  'code' => '007', 'active' => true, 'percentage' => 0, 'description' => 'Caña de azúcar'],
            ['id' => '54008',  'code' => '008', 'active' => true, 'percentage' => 4, 'description' => 'Madera'],
            ['id' => '54009',  'code' => '009', 'active' => true, 'percentage' => 0, 'description' => 'Arena y piedra'],
            ['id' => '54010',  'code' => '010', 'active' => true, 'percentage' => 0, 'description' => 'Residuos, subproductos, desechos, recortes y desperdicios'],
            ['id' => '54011',  'code' => '011', 'active' => true, 'percentage' => 0, 'description' => 'Bienes gravados con el IGV, o renuncia a la exoneración'],
            ['id' => '54012',  'code' => '012', 'active' => true, 'percentage' => 0, 'description' => 'Intermediación laboral y tercerización'],
            ['id' => '54013',  'code' => '013', 'active' => true, 'percentage' => 0, 'description' => 'Animales vivos'],
            ['id' => '54014',  'code' => '014', 'active' => true, 'percentage' => 4, 'description' => 'Carnes y despojos comestibles'],
            ['id' => '54015',  'code' => '015', 'active' => true, 'percentage' => 0, 'description' => 'Abonos, cueros y pieles de origen animal'],
            ['id' => '54016',  'code' => '016', 'active' => true, 'percentage' => 0, 'description' => 'Aceite de pescado'],
            ['id' => '54017',  'code' => '017', 'active' => true, 'percentage' => 4, 'description' => 'Harina, polvo y “pellets” de pescado, crustáceos, moluscos y demás invertebrados acuáticos'],
            ['id' => '54019',  'code' => '019', 'active' => true, 'percentage' => 0, 'description' => 'Arrendamiento de bienes muebles'],
            ['id' => '54020',  'code' => '020', 'active' => true, 'percentage' => 0, 'description' => 'Mantenimiento y reparación de bienes muebles'],
            ['id' => '54021',  'code' => '021', 'active' => true, 'percentage' => 0, 'description' => 'Movimiento de carga'],
            ['id' => '54022',  'code' => '022', 'active' => true, 'percentage' => 0, 'description' => 'Otros servicios empresariales'],
            ['id' => '54024',  'code' => '024', 'active' => true, 'percentage' => 0, 'description' => 'Comisión mercantil'],
            ['id' => '54025',  'code' => '025', 'active' => true, 'percentage' => 0, 'description' => 'Fabricación de bienes por encargo'],
            ['id' => '54026',  'code' => '026', 'active' => true, 'percentage' => 0, 'description' => 'Servicio de transporte de personas'],
            ['id' => '54027',  'code' => '027', 'active' => true, 'percentage' => 4, 'description' => 'Servicio de transporte de carga'],
            ['id' => '54028',  'code' => '028', 'active' => true, 'percentage' => 0, 'description' => 'Transporte de pasajeros'],
            ['id' => '54030',  'code' => '030', 'active' => true, 'percentage' => 4, 'description' => 'Contratos de construcción'],
            ['id' => '54031',  'code' => '031', 'active' => true, 'percentage' => 0, 'description' => 'Oro gravado con el IGV'],
            ['id' => '54034',  'code' => '034', 'active' => true, 'percentage' => 0, 'description' => 'Minerales metálicos no auríferos'],
            ['id' => '54035',  'code' => '035', 'active' => true, 'percentage' => 0, 'description' => 'Bienes exonerados del IGV'],
            ['id' => '54036',  'code' => '036', 'active' => true, 'percentage' => 0, 'description' => 'Oro y demás minerales metálicos exonerados del IGV'],
            ['id' => '54037',  'code' => '037', 'active' => true, 'percentage' => 0, 'description' => 'Demás servicios gravados con el IGV'],
            ['id' => '54039',  'code' => '039', 'active' => true, 'percentage' => 0, 'description' => 'Minerales no metálicos'],
            ['id' => '54040',  'code' => '040', 'active' => true, 'percentage' => 4, 'description' => 'Bien inmueble gravado con IGV'],
        ]);

        /* CODIGOS DE IDENTIFICACION DEL CONCEPTO TRIBUTARIO - CATALOGO 55 */

        Schema::create('cat_tax_types', function (Blueprint $table) {
            $table->string('id')->index();
            $table->boolean('active');
            $table->string('description');
        });

        DB::table('cat_tax_types')->insert([
        ...
        /* CODIGOS DE TIPO DE MEDIOS DE PAGO - CATALOGO 59 */
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists('codes_items_services_subject_detraction');
        Schema::dropIfExists('cat_tax_types');
